...
export const initialDataConstants = {
    GET_ALL_INTIAL_DATA_REQUEST:'GET_ALL_INTIAL_DATA_REQUEST',
    GET_ALL_INTIAL_DATA_SUCCESS:'GET_ALL_INTIAL_DATA_SUCCESS',
    GET_ALL_INTIAL_DATA_FAILURE:'GET_ALL_INTIAL_DATA_FAILURE'
}